 ...
 *
 * @param otherState The second [State] to combine.
 ...
 * Combine multiple [State].
 *
 * @param otherState1 The second [State] to combine.
 * @param otherState2 The third [State] to combine.
 * @param transform This callback that returns the result of combining the data.
 * @return Return [State] containing the combined data.
 */
 ...
 * @param otherState1 The second [State] to combine.
 * @param otherState2 The third [State] to combine.
 * @param otherState3 The fourth [State] to combine.
 * @param transform This callback that returns the result of combining the data.
 * @return Return [State] containing the combined data.
 */
 ...
 * @param otherState2 The third [State] to combine.
 * @param otherState3 The fourth [State] to combine.
 * @param otherState4 The fifth [State] to combine.
 * @param transform This callback that returns the result of combining the data.
 * @return Return [State] containing the combined data.
 */
