internal object PublishingInfo {
    const val versionName = "5.4.0-SNAPSHOT"
    ...
    const val developerName = "KazaKago"
    const val developerEmail = "kazakago@gmail.com"
    const val developerUrl = "https://blog.kazakago.com/"
}
